...
ANSIBLE_GROUPS = {
    ...
    "lb" => ["node5"],
    "all_groups:children" => ["master", "nodes", "lb"]
}
...
#        node1.vm.network "public_network", ip: "192.168.13.10"
    node1.vm.network :forwarded_port, guest: 5050, host: 25050 # mesos
    ...
    node1.vm.network :forwarded_port, guest: 4400, host: 24400 # chronos
  ...
  config.vm.define "node5" do |node5|
    node5.vm.network "private_network", ip: "192.168.12.14"
